...
│  │  ├─ difficulty.ts   # 难度档（简单/普通/困难）参数表
│  │  ├─ highscore.ts    # localStorage 最高分（按难度档）
│  │  ├─ achievements.ts # ★ 成就系统（20 个）+ 注册表
